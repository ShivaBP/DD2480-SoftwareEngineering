...
public class Decide {
    ...
    boolean lic13(Parameters_T variables) {
        ...
        if (NUMPOINTS >= 5 && variables.RADIUS2 >= 0 && NUMPOINTS >= variables.APTS + variables.BPTS + 3) {
            // set of points
            int i = 0;
            ...
            while (k < NUMPOINTS ) {
                ...
                if (distanceij <= diameter2 && distancejk <= diameter2 && distanceik <= diameter2) {
                    condition2 = true;
                }
                if (condition1 == true && condition2 == true) {
                    return true;
